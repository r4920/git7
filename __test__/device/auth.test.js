...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Elvis_Maggio',
      password: 'yq8o463u_EmHhWs',
      email: 'Bernice.Schuster@hotmail.com',
      name: 'Douglas Conroy',
      userType: 415,
      mobileNo: '1-747-763-7252 x726',
      resetPasswordLink: {},
      loginRetryLimit: 30,
      loginReactiveTime: '2023-02-09T09:37:50.060Z',
      id: '62287f679daac00f9153e0a6'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Merl.Beier',
        'password':'bShPd9ALmPYuBr1',
        'email':'Otto_Conn28@hotmail.com',
        'name':'Gwendolyn Rolfson',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'324-418-8277',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Otto_Conn28@hotmail.com', });
