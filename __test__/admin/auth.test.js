...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Jaylan.Rodriguez',
      password: 'wfI5bSWfndnMQxR',
      email: 'Mia.Wunsch@hotmail.com',
      name: 'Luis Kihn',
      userType: 384,
      mobileNo: '331.453.7522',
      resetPasswordLink: {},
      loginRetryLimit: 740,
      loginReactiveTime: '2022-07-19T16:14:44.183Z',
      id: '62287f679daac00f9153e082'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Roger.Gibson',
        'password':'POThrWTzxXz8rm4',
        'email':'Ray81@gmail.com',
        'name':'Brandi Marvin',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'922-635-3153 x7725',
